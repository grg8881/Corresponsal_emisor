 ...
 * @see co.edu.campusucc.sd.modelo.Empleado
...
public class EmpleadoDAO {
	...
	public Empleado findById(java.lang.String id) {
		logger.log(Level.INFO, "getting Empleado instance with id: " + id);
		try {
			Empleado instance = (Empleado) sessionFactory.getCurrentSession().get("co.edu.campusucc.sd.modelo.Empleado",
					id);
			if (instance == null) {
	...
	public List findByExample(Empleado instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("co.edu.campusucc.sd.modelo.Empleado")
