 ...
 * @see co.edu.campusucc.sd.modelo.VerificacionMontoPermitido
...
public class VerificacionMontoPermitidoDAO {
	...
	public VerificacionMontoPermitido findById(java.lang.String id) {
		...
		try {
			VerificacionMontoPermitido instance = (VerificacionMontoPermitido) sessionFactory.getCurrentSession()
					.get("co.edu.campusucc.sd.modelo.VerificacionMontoPermitido", id);
			if (instance == null) {
	...
	public List findByExample(VerificacionMontoPermitido instance) {
		logger.log(Level.INFO, "finding VerificacionMontoPermitido instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("co.edu.campusucc.sd.modelo.VerificacionMontoPermitido")
