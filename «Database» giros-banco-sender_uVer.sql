...
/*  Created On : 23-may.-2020 07:39:11 a. m. 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	...
	id_tipo_documento varchar(50) NULL,
...
(
	...
	num_documento_emp varchar(50) NULL
)
;

CREATE TABLE forma_pago_estatica
(
	id_Forma_de_Pago varchar(50) NOT NULL,
...
CREATE TABLE giros
(
	id_giros varchar(50) NOT NULL,
	id_cliente varchar(50) NULL,
	id_origen varchar(50) NULL,
	Fecha_Giro varchar(50) NULL,
	Costo_Giro varchar(50) NULL,
	id_destino varchar(50) NULL,
	id_pais varchar(50) NULL,
	Id_locutorio varchar(50) NULL,
	id_administrador varchar(50) NULL,
	id_empleado varchar(50) NULL,
	id_verificar_monto_permitido varchar(50) NULL,
	id_verficar_monto varchar(50) NULL,
	id_Forma_de_Pago varchar(50) NULL
)
;
...
(
	...
	id_comprobante_recepcion_giro varchar(50) NULL,
	id_giros varchar(50) NULL
)
;
...
(
	...
	cod_negociacion varchar(50) NULL,
	comi_broker_que_envia varchar(50) NULL,
	comi_banco varchar(50) NULL,
	comi_broker_recepcion varchar(50) NULL,
	tax_pais_emisor varchar(50) NULL,
	FECHA_VIGENCIA_INICIAL varchar(50) NULL,
	FECHA_VIGENCIA_FINAL varchar(50) NULL
)
;
...
(
	...
	fecha_ultimo_camkbio_residencia varchar(50) NULL
)
;
...
(
	...
	id_giro varchar(50) NULL,
	id_giros varchar(50) NULL,
	verficar_monto_permitido varchar(50) NULL,
	valor_monto_permitido varchar(50) NULL,
	id_verficar_monto varchar(50) NOT NULL
)
;
